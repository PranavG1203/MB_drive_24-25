  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex w-full flex-col space-y-5 md:space-y-0 md:flex-row bg-[#010A26] border-[8px] border-opacity-20 mt-2 border-zinc-400 rounded-lg lg:justify-evenly justify-center p-6 items-center lg:px-12">
          ...
          <div className="space-y-2">
            ...
            <div className="flex space-x-2 justify-center md:justify-start">
              ...
              <a href="https://mobile.twitter.com/wcewlug" target="_blank">
                <FaXTwitter className="text-3xl text-white cursor-pointer hover:scale-110 hover:text-blue-400 transition-all" />
              </a>
              <a href="https://discord.com/invite/3ce8hBZfc8" target="_blank">
          ...
          <div className="space-y-2 text-white text-center lg:text-left">
            <a href="https://memberboard2k24.wcewlug.org" target="_blank">
              Home
            </a>
            <br />
